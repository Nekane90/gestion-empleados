		...
		btEmpleados.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
			    try {
			        ...
			        // Llenar el reporte (Pasamos 'jr', los 'parametros' y la conexión 'con')
			        //  Si este informe no usa filtros todavía, 'parametros' solo llevará el logo.
		...
		btFichajes.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				try {
			        ...
			        // Cargar el diseño (.jrxml)
			        JasperDesign jd = JRXmlLoader.load("informes/FichajeEmpleados.jrxml");
